...
export const clienteCrearSchema = clientesSchema.omit({ id: true, fecha_registro: true })

export const clienteActualizarSchema = clientesSchema.omit({ id: true, fecha_registro: true })